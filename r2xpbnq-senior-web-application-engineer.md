...
Please [authorize our Github OAuth2 application ](http://localhost:3000/users/auth/github?job_id=r2xpbnq-senior-web-application-engineer) to be redirected to the private repo.
