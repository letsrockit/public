...
Please [authorize our Github OAuth2 application](https://letsrockit.co/users/auth/github?job_id=twfnzw50yq-hardware-engineer-senior-firmware-embedded) to be redirected to the private repo.
