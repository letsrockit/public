...
Please [authorize our Github OAuth2 application](https://letsrockit.co/users/auth/github?job_id=thv4b3r0awnh-frontend-engineer) to be redirected to the private repo.
