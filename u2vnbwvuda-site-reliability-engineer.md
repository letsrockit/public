...
Please [authorize our Github OAuth2 application ](http://localhost:3000/users/auth/github?job_id=u2vnbwvuda-site-reliability-engineer) to be redirected to the private repo.
